				...
				if (
					...
					if (
						...
						if ( !empty( $sa_post_id ) ) {
							...
							add_post_meta( $sa_post_id, '_attachment', sanitize_text_field($attachent) );
						}
						...
						if (
							...
							$_SESSION[ CF7SA_META_PREFIX . 'form_message' . $form_ID ] = serialize( __( 'Transaction is successfully sompleted.', CF7SA_PREFIX ) );
